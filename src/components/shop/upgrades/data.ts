...
export const upgrades: Upgrades = {
    ...
    [UpgradeType.Cursor]: {
        ...
        1: {
            name: "Iron mouse",
            description: `Clicking gains +5% of your CpS. "Click like it's 1,349!"`,
            price: 5e6,
            image: icons[UpgradeType.Clicker][0],
        ...
        2: {
            name: "Titanium mouse",
            description: `Clicking gains +5% of your CpS. "Heavy, but powerful."`,
            price: 5e8,
            image: icons[UpgradeType.Clicker][0],
        ...
        3: {
            ...
            description: "Clicking gains +5% of your CpS.",
            price: 5e10,
            image: icons[UpgradeType.Clicker][0],
        ...
        4: {
            ...
            description: `Clicking gains +5% of your CpS. "You could cut diamond with these."`,
            price: 5e12,
            image: icons[UpgradeType.Clicker][0],
        ...
        5: {
            name: "Eludium mouse",
            description: `Clicking gains +5% of your CpS. "These nice mice should suffice."`,
            price: 5e14,
            image: icons[UpgradeType.Clicker][0],
